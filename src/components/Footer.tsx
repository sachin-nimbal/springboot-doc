    ...
    <footer className="border-t border-border bg-background/50 mt-16">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-sm text-muted-foreground">
              Build powerful REST APIs with Spring Boot in minutes.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link to="/annotations" className="text-muted-foreground hover:text-foreground transition-colors">
                  Annotations
                </Link>
              </li>
              <li>
                <Link to="/rest-endpoints" className="text-muted-foreground hover:text-foreground transition-colors">
                  API Reference
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-border flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">
            © {currentYear} CrudX Framework. All rights reserved.
          </p>
